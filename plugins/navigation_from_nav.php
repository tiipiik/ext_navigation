 ...
 */
class Plugin_Navigation_from_nav extends Plugin
{

	public $version = '1.0.0';
	public $name = array(
		'en' => 'Navigation From Nav',
	);
	public $description = array(
		'en' => 'Build navigation links from parent level of navigation, and find children in Pages, including links in dropdown menus.',
	);
	...
	/* reforged function to get pages children from navigation */
	public function links()
	{
        // load navigation model
		//class_exists('Navigation_m') OR $this->load->model('navigation/navigation_m');
		class_exists('Navigation_from_nav_m') OR $this->load->model('navigation/navigation_from_nav_m');
		...
		$links = $this->navigation_from_nav_m->get_link_tree_from_nav($group, $params);
